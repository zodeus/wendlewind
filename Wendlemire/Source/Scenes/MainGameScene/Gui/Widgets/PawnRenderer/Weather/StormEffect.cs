...
public class StormEffect : BaseWeatherEffect
{
    ...
    private void RenderLightningBolt(SpriteBatch spriteBatch, LightningBolt bolt, Wendlemire.Graphics.Sprite pixel, float scale)
    {
    ...
    private void DrawLightningPath(SpriteBatch spriteBatch, Wendlemire.Graphics.Sprite pixel, List<Vector2> points, 
