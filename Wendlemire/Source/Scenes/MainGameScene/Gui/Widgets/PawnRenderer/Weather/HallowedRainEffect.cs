...
public class HallowedRainEffect : BaseWeatherEffect
{
    ...
    private void RenderSacredMote(SpriteBatch spriteBatch, Wendlemire.Graphics.Sprite pixel,
    ...
    private void RenderRainDrop(SpriteBatch spriteBatch, Wendlemire.Graphics.Sprite pixel,
