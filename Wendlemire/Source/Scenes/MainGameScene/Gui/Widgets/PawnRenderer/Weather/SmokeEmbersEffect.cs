...
public class SmokeEmbersEffect : BaseWeatherEffect
{
    ...
    private void RenderEmber(SpriteBatch spriteBatch, Wendlemire.Graphics.Sprite pixel, 
    ...
    private void RenderSmoke(SpriteBatch spriteBatch, Wendlemire.Graphics.Sprite pixel, 
        WeatherParticle particle, Vector2 scaledPos, float scaledSize)
    {
