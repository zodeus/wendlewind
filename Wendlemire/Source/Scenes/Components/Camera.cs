...
namespace Wendlemire.Scenes.Components;
...
public sealed class Camera : IDisposable {
    ...
    void ScaleViewportToVirtualRes() {
        ...
        _graphicsDevice.Viewport = new Viewport((_graphicsDevice.PresentationParameters.BackBufferWidth / 2) - (width2 / 2),
            (_graphicsDevice.PresentationParameters.BackBufferHeight / 2) - (height2 / 2), width2, height2);
    }
}