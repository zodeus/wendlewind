...
/// </summary>
public readonly record struct BodyPartLayoutData
{
    /// <summary>
    ...
    public EquipmentAttachmentData? EquipmentAttachment { get; init; }
...
public static class BodyPartRenderHelper
{
        ...
        Vector2? offset = null)
    {
        ...
        foreach (var (slotType, item) in part.Equipment)
        {
            ...
            var weaponTexture = PawnTextures.GetTexture(item.ItemDef);
        ...
        Vector2? offset = null)
    {
        ...
        foreach (var (slotType, item) in part.Equipment)
        {
            ...
            var armorTexture = PawnTextures.GetTexture(item.ItemDef);
