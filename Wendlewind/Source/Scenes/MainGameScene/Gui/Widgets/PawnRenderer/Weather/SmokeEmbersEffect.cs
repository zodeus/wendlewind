...
public class SmokeEmbersEffect : BaseWeatherEffect
{
    ...
    private void RenderEmber(SpriteBatch spriteBatch, Wendlewind.Graphics.Sprite pixel, 
    ...
    private void RenderSmoke(SpriteBatch spriteBatch, Wendlewind.Graphics.Sprite pixel, 
        WeatherParticle particle, Vector2 scaledPos, float scaledSize)
    {
