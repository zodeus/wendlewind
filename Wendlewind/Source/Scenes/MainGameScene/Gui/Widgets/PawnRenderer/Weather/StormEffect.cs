...
public class StormEffect : BaseWeatherEffect
{
    ...
    private void RenderLightningBolt(SpriteBatch spriteBatch, LightningBolt bolt, Wendlewind.Graphics.Sprite pixel, float scale)
    {
    ...
    private void DrawLightningPath(SpriteBatch spriteBatch, Wendlewind.Graphics.Sprite pixel, List<Vector2> points, 
