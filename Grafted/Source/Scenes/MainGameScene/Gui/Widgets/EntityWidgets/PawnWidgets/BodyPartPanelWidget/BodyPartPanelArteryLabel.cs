...
internal sealed class BodyPartPanelArteryLabel : Label
{
    private readonly BodyPart _bodyPart;

    public BodyPartPanelArteryLabel(BodyPart bodyPart)
    {
    ...
    {
        Visible = _bodyPart.IsArteryFunctional == false;
    }
}