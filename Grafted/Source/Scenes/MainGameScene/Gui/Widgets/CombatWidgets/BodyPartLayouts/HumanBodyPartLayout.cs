...
public class HumanBodyPartLayout : IBodyPartLayout
{
    ...
    private static readonly Dictionary<string, BodyPartLayoutData> PartLayoutMap = new()
    {
        ...
        { "Left Hand", new BodyPartLayoutData(new Vector2(294f, 291f), 19, 0.50f, -0.2793f, flipHorizontal: true, equipmentAttachment: new EquipmentAttachmentData(new Vector2(40f, 29f), 0.2793f, 0.90f, false)) },
        ...
        { "Right Hand", new BodyPartLayoutData(new Vector2(127f, 286f), 59, 0.50f, 0.3840f, equipmentAttachment: new EquipmentAttachmentData(new Vector2(36f, 33f), 0.2269f, 1.00f, false)) },
    };
