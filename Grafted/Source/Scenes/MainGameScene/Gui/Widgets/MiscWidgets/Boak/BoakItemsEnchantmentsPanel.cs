...
internal sealed class BoakItemEnchantmentCard : Panel
{
    private const int IconSize = 96;

    public BoakItemEnchantmentCard(ItemDef def)
    {
...
internal sealed class BoakItemsEnchantmentsPanel : ScrollViewer
{
    public BoakItemsEnchantmentsPanel(IReadOnlyList<ItemDef> defs)
    {
        ...
        {
            var card = new BoakItemEnchantmentCard(def);
