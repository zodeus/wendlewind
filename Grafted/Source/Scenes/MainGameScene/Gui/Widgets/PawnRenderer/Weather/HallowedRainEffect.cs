...
public class HallowedRainEffect : BaseWeatherEffect
{
    ...
    private void RenderSacredMote(SpriteBatch spriteBatch, Grafted.Graphics.Sprite pixel,
    ...
    private void RenderRainDrop(SpriteBatch spriteBatch, Grafted.Graphics.Sprite pixel,
