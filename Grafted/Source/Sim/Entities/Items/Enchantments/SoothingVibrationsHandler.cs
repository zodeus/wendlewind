...
{
    private const int DurationInTicks = 80;
    public override void HandlePawnTakeDamage(BodyPart bodyPart, Pawn pawn, Pawn requestSource, DamageRecord damageRecord)
    {
