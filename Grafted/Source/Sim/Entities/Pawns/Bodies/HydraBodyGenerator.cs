...
public class HydraBodyGenerator : IBodyGenerator
{
    public void Generate(Pawn pawn)
    {
        ...
        var torso = pawn.Body.RootSocket.TryAttachPart(EntityGenerator.CreateEntity<BodyPart>(Defs.BodyParts.HydraTorso));
        ...
        headOne.Equipment[EquipmentSlotType.BuiltIn] = EntityGenerator.CreateEntity<Item>(DefRepository<ItemDef>.GetByMoniker("HydraTeeth")!);
        ...
        headTwo.Equipment[EquipmentSlotType.BuiltIn] = EntityGenerator.CreateEntity<Item>(DefRepository<ItemDef>.GetByMoniker("HydraTeeth")!);
        ...
        headThree.Equipment[EquipmentSlotType.BuiltIn] = EntityGenerator.CreateEntity<Item>(DefRepository<ItemDef>.GetByMoniker("HydraTeeth")!);
