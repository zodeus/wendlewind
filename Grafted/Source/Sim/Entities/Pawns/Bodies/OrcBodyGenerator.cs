...
public class OrcBodyGenerator : IBodyGenerator
{
    public void Generate(Pawn pawn)
    {
        ...
        var head = pawn.Body.RootSocket.TryAttachPart(EntityGenerator.CreateEntity<BodyPart>(Defs.BodyParts.OrcHead));
        ...
        // Neck
        var neck = head.GetSocketsFor(BodyPartType.Neck)[0].TryAttachPart(Defs.BodyParts.OrcNeck);
        ...
        //Torso
        var torso = neck.GetSocketsFor(BodyPartType.Torso)[0].TryAttachPart(Defs.BodyParts.OrcTorso);
