...
public class PawnPanel : EntityPanelBase {
    ...
    public PawnPanel(Pawn pawn, EntityPanelProperties? properties = null) : base(pawn, properties) {
        _pawn = pawn;
        MinWidth = 1000;
        MinHeight = 800;
        ...
        */
        ...
        EntityListPanel inventoryPanel = new(pawn.Inventory.Entities, null, itemToGive => {
