...
public class GameHud : HorizontalStackPanel {
    ...
    public void Update() {
        ...
        _distanceLabel.Text = $"{Core.Sim.World.CurrentZone.DistanceTraveledThisRun.ToString("0.00")}km ({Mathf.RoundToInt(Core.Sim.World.CurrentZone.PercentTraveled * 100)}%) " +
