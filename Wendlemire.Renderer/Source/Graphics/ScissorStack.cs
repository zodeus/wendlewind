...
public static class ScissorStack {
    ...
    public static bool PushScissors(Rectangle scissor) {
        ...
        RenderHost.GraphicsDevice.ScissorRectangle = scissor;
    ...
    public static Rectangle PopScissors() {
        ...
        if (_scissors.Count == 0)
            RenderHost.GraphicsDevice.ScissorRectangle = RenderHost.GraphicsDevice.Viewport.Bounds;
        else
            RenderHost.GraphicsDevice.ScissorRectangle = _scissors.Peek();
