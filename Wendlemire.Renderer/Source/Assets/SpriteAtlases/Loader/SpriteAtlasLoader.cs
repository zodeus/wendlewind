...
namespace Wendlemire.Assets.SpriteAtlases.Loader;
...
public static class SpriteAtlasLoader {
    ...
    public static SpriteAtlas ParseSpriteAtlas(string dataFile, bool premultiplyAlpha = false) {
        ...
        return spriteAtlas.AsSpriteAtlas(premultiplyAlpha ? TextureUtils.TextureFromStreamPreMultiplied(stream) : Texture2D.FromStream(RenderHost.GraphicsDevice, stream));
    }
